...
原版邮箱界面中充斥着各类广告、推广链接以及非核心功能（如 AI 助手、会员推广等）。本脚本旨在通过**移除视觉干扰**和**自动化辅助**，还原邮箱最纯粹的收发信功能。

## ⚙️ 使用说明

1. 安装脚本后，刷新 163 邮箱页面。
2. 点击浏览器扩展栏中的油猴图标，找到“163 Mail Pro”脚本并选择“设置”，或者点击导航栏中的“163 Mail Pro”。
3. 在弹出的设置面板中勾选你需要隐藏的模块或开启的增强功能，即时生效。
...
### ⚡ 功能增强 (自动化)
- **始终“普通打开”链接**：
  - 检测到外链跳转安全警示页时，自动点击“普通打开”按钮，跳过等待直接访问目标网页。
